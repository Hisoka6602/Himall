...
namespace Himall.OpenApi.Model.Parameter
{
    ...
    public class ChangLogisticsParameterModel : BaseParameterModel
    {
        ...
        public override bool CheckParameter()
        {
            ...
            {
                throw new HimallApiException(OpenApiErrorCode.Biz_Order_ID_is_Invalid, "tid");
            }
            ...
            {
                throw new HimallApiException(OpenApiErrorCode.Missing_Required_Arguments, "company_name");
            }
            if (string.IsNullOrWhiteSpace(out_sid))
            {
                throw new HimallApiException(OpenApiErrorCode.Missing_Required_Arguments, "out_sid");
            }

            if (this.out_sid.Length > 100)
            {
                throw new HimallApiException(OpenApiErrorCode.Out_Sid_Too_Long, "out_sid");
            }
