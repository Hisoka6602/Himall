...
namespace Himall.API
{
    public class CartController : BaseApiController
    {
        public object GetCartProduct()
        {
            ...
            var cartHelper = ServiceProvider.Instance<CartService>.Create;
        ...
        public object PostDeleteCartProduct(CartDeleteCartProductModel value)
        {
            ...
            ServiceProvider.Instance<CartService>.Create.DeleteCartItem(skuIdsArr, CurrentUser.Id);
        ...
        public object PostUpdateCartItem(CartUpdateCartItemModel value)
        {
            ...
            var cartService = ServiceProvider.Instance<CartService>.Create;
            var ladderPrice = 0m;
            long productId = 0;
            ...
            foreach (var item in cart.Items)
            {
                ...
                if (null != shop)
                {
                    ...
                    if (sku != null)
                    {
                        ...
                        var picimg = Core.HimallIO.GetRomoteProductSizeImage(product.RelativePath, 1, (int)Himall.CommonModel.ImageSize.Size_150);
