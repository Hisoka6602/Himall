    ...
    public class ShopBranchProductController : BaseShopBranchLoginedApiController
    {
            ...
            )
        {
            ...
            var product = products.Models.Select(item => new
            {
                ...
                salesCount = item.SaleCounts + Himall.Core.Helper.TypeHelper.ObjectToInt(item.VirtualSaleCounts),
                img = Core.HimallIO.GetRomoteProductSizeImage(item.RelativePath, 1, (int)ImageSize.Size_100),
