...
{
    public class BrandApplication:BaseApplicaion<BrandService>
	{
		/// <summary>
		/// 添加一个品牌
		/// </summary>
		...
		public static void AuditBrand(long id, Himall.Entities.ShopBrandApplyInfo.BrandAuditStatus status,string remark)
		{
		...
		/// <param name="pageSize">每页显示多少条数据</param>
		/// <returns></returns>
		public static QueryPageModel<DTO.Brand> GetShopBrands(long shopId, int pageNo, int pageSize,string keywords="")
		{
			var list = Service.GetShopBrands(shopId, pageNo, pageSize, keywords);
			return new QueryPageModel<DTO.Brand>
			{
				Models = list.Models.Map<List<DTO.Brand>>(),
				Total = list.Total
