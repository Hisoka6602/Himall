...
namespace Himall.Application
{
    ...
    {
        #region 字段
        private static MemberService _MemberService = ObjectContainer.Current.Resolve<MemberService>();
        private static ExpressDaDaService _iExpressDaDaService = ObjectContainer.Current.Resolve<ExpressDaDaService>();
        #endregion
        /// <summary>
        /// 取消发单
        /// </summary>
