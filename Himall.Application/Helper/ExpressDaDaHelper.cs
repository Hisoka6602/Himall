...
namespace Himall.Application
{
    ...
    public class ExpressDaDaHelper
    {
        ...
        public static string shopAdd(long shopId, string station_name, int business, string city_name, string area_name, string station_address, decimal lng, decimal lat, string contact_name, string phone, string origin_shop_id = "", string id_card = "", string username = "", string password = "")
        {
        ...
        public static string shopUpdate(long shopId, string origin_shop_id, string station_name = "", int business = -1, string city_name = "", string area_name = "", string station_address = "", decimal lng = -1, decimal lat = -1, string contact_name = "", string phone = "", int status = -1, string new_shop_id = "")
        {
            SortedDictionary<string, object> tparams = new SortedDictionary<string, object>();
            tparams.Add("origin_shop_id", origin_shop_id);
        ...
        /// </returns>
        public static string addOrder(long shopId, string shop_no, string origin_id, string city_code, double cargo_price, int is_prepay, long expected_fetch_time, string receiver_name, string receiver_address, decimal receiver_lat, decimal receiver_lng, string callback, string receiver_phone = "", string receiver_tel = "", double cargo_weight = -1, double tips = -1, double pay_for_supplier_fee = -1, double fetch_from_receiver_fee = -1, double deliver_fee = -1, long create_time = -1, string info = "", int cargo_type = -1, int cargo_num = -1, long expected_finish_time = -1, string invoice_title = "", string deliver_locker_code = "", string pickup_locker_code = "", bool isReAddOrder = false, bool isQueryDeliverFee = false)
        {
            SortedDictionary<string, object> tparams = new SortedDictionary<string, object>();
            ...
            tparams.Add("cargo_weight", cargo_weight>0? cargo_weight:1);
