...
namespace Himall.Application
{
    public class OrderAndSaleStatisticsApplication
    {
        ...
        private static OrderAndSaleStatisticsService _iOrderAndSaleStatisticsService = ObjectContainer.Current.Resolve<OrderAndSaleStatisticsService>();
        ...
        public static QueryPageModel<BranchShopFeat> GetBranchShopFeat(BranchShopFeatsQuery query)
        {
            ...
            {
                var branchShop = ShopBranchApplication.GetStores(ids);
