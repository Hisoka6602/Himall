...
{
    public class WeiActivityApplication:BaseApplicaion<WeiActivityInfoService>
    {
        ...
        private static WeiActivityWinService _iWeiActivityWinService = ObjectContainer.Current.Resolve<WeiActivityWinService>();
        private static WeiActivityInfoService _iActivityInfoService = ObjectContainer.Current.Resolve<WeiActivityInfoService>();
        ...
        public static void WinnerSubmit(WeiActivityWinModel winModel)
        {
            ...
            {
                var factoryService = ServiceProvider.Instance<MemberIntegralConversionFactoryService>.Create;
        ...
        public static IEnumerable<Entities.BonusInfo> GetBonusByType(Himall.Entities.BonusInfo.BonusType bonusType)
        {
