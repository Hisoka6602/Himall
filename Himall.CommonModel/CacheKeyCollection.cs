...
namespace Himall.CommonModel
{
    ...
    public static class CacheKeyCollection
    {
        ...
        /// 高德同步地址库状态值
        /// </summary>
        public const string GaoDRegionSyncStatus = "Cache-RegionSyncStatus";
        ...
        //店铺的OpenApi缓存
        public static string Cache_ShopApiSite(long shopid)
        {
            return string.Format("Cache_ShopApiSite{0}", shopid);
        }
