...
namespace Himall.CommonModel
{
    public enum SellerPrivilege
    {
        ...
        [Privilege("商品", "数据导入", 2008, "ProductImport/ImportManage", "ProductImport")]
        ...
        MobileTopic = 7004,
        [Privilege("营销", "小程序直播", 7009, "Live/Management", "Live")]
        Live = 7009,
        [Privilege("营销", "主播列表", 7010, "Live/AnchorList", "Live")]
        AnchorList = 7010,
        [Privilege("营销", "直播商品库", 7011, "Live/LiveProductLibaray", "Live")]
        LiveProductLibaray = 7011,
        /*分销*/
        ...
        [Privilege("微店", "微信端配置", 9002, "VTemplate/EditTemplate", "VTemplate","",AdminCatalogType=AdminCatalogType.Default, LinkTarget = TargetType.Blank)]
        VTemplate = 9002,
