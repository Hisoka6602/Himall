...
namespace Himall.DTO.Distribution
{
    public class DistributorListDTO
    {
        ...
        public string ShowName { get { return string.IsNullOrEmpty(CellPhone) ? (string.IsNullOrEmpty(NickName) ? MemberName : NickName) : CellPhone; } }
        /// <summary>
        /// 上级编号
        /// </summary>
