...
namespace Himall.DTO
{
    ...
    public class OrderSubmitModel
    {
        ...
        /// 用户信息
        /// </summary>
        public Himall.Entities.MemberInfo Member { get; set; }
        ...
        /// 平台优惠券列表
        /// </summary>
        public List<BaseCoupon> BaseCouponsPlat { get; set; }
        /// <summary>
        /// 当前选中平台优惠券
        /// </summary>
        public BaseCoupon OneCouponsPlat { get; set; }
    }
    ...
    public class OrderErrorModel {
        public SKUInfo skuinfo { set; get; }
        public long skustock { set; get; }
    }
}
