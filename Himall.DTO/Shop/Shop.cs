...
namespace Himall.DTO
{
    ...
    /// 店铺信息表
    /// </summary>
    public class Shop:Himall.Entities.ShopInfo
    {
        /// <summary>
        /// 店铺ID
        /// </summary>
        ...
        /// 店铺进度
        /// </summary>
        public Himall.Entities.ShopInfo.ShopStage Stage { get; set; }

        /// <summary>
        /// 店铺状态
        /// </summary>
        public Himall.Entities.ShopInfo.ShopAuditStatus ShopStatus { get; set; }
        ...
        public bool IsOpenHiChat { get; set; }
