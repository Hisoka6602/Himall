...
namespace Himall.DTO
{
    public class SiteSettings
    {
        public SiteSettings()
        {
            QQMapAPIKey = "SYJBZ-DSLR3-IWX3Q-3XNTM-ELURH-23FTP";//默认值
        ...
        /// 是否去版权
        /// </summary>
        public bool IsOpenCopyRight { get; set; }
        ///// <summary>
        ///// 是否授权多门店小程序
        ///// </summary>
        ...
        /// <summary>
        /// 是否开启充值(关闭后小程序消费者无法充值，可用来快速通过微信审核)
        /// </summary>

        public bool IsOpenRecharge { set; get; }
        ...
        /// 分销重命名-我的名片
        /// </summary>
        public string DistributorRenameMyBusinessCard { get; set; } = "我的名片";
        ...
        /// 阿里云防盗刷云盾人机验证appKey
        /// </summary>
        public string SlideValidateAppKey { get; set; }
        /// <summary>
        /// 是否开启阿里云防盗刷
        /// </summary>
        public bool IsTheftBrush { get; set; }
        ...
        public int PhoneSmsCount { set; get; }
