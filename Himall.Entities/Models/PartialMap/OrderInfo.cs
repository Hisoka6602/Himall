...
namespace Himall.Entities
{
    public partial class OrderInfo
    {
            ...
            get
            {
                ...
                switch (this.OrderStatus)
                {
                    ...
                    case OrderOperateStatus.WaitReceiving:
                        result = this.ProductTotalAmount - this.FullDiscount - this.DiscountAmount - this.PlatDiscountAmount - this.RefundTotalAmount;   //商品总价 - 优惠券 - 已退金额
                        break;
                    case OrderOperateStatus.WaitDelivery:
                        result = this.ProductTotalAmount + this.Freight + this.Tax - this.DiscountAmount - this.PlatDiscountAmount - this.FullDiscount;            //待发货退还运费
                        break;
                    case OrderOperateStatus.WaitSelfPickUp:
                        result = this.ProductTotalAmount - this.DiscountAmount - this.PlatDiscountAmount - this.FullDiscount - this.RefundTotalAmount + this.Tax;
                        break;
                }
                return result;
            }
        ...
        public bool CanBackOut()
        {
            ...
            {
                if (!string.IsNullOrWhiteSpace(GatewayOrderId) && (this.PaymentTypeGateway.ToLower().Contains("weixin") || this.PaymentTypeGateway.ToLower().Contains("alipay")))
                {
                    result = true;
                }
            }
        ...
        /// </summary>
        [ResultColumn]
        public decimal ProductTotal { get { return this.ProductTotalAmount - this.DiscountAmount - this.PlatDiscountAmount - this.FullDiscount; } }
        ...
        /// </summary>
        [ResultColumn]
        public decimal OrderTotalAmount { get { return this.ProductTotalAmount + this.Freight + this.Tax - this.IntegralDiscount - this.DiscountAmount - this.PlatDiscountAmount - this.FullDiscount; } }

        /// <summary>
        /// 订单金额 （商品应付+运费+税 -优惠券金额-满额减金额）  (未减掉积分抵扣部分)
        /// </summary>
        [ResultColumn]
        public decimal OrderAmount { get { return this.ProductTotalAmount + this.Freight + this.Tax - this.DiscountAmount - this.PlatDiscountAmount - this.FullDiscount; } }
        ...
        public bool OrderWaitPayAmountIsZero
        {
            get
            {
                return (this.ProductTotalAmount + this.Freight + this.Tax - this.IntegralDiscount - this.DiscountAmount - this.PlatDiscountAmount - this.FullDiscount - this.CapitalAmount) == 0;
            }
        }
        /// <summary>
        /// 需要第三方支付的金额
        ...
        public decimal OrderPayAmount
        {
            get
            {
                var amount = this.ProductTotalAmount + this.Freight + this.Tax - this.IntegralDiscount - this.DiscountAmount - this.PlatDiscountAmount - this.FullDiscount - this.CapitalAmount;
                if (amount > 0 && this.OrderStatus != OrderOperateStatus.WaitPay)
                {
                    return amount;
                }
                return 0;
