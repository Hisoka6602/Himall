...
namespace NetRube.Data
{
    ...
    public class Database : IDisposable
    {
        ...
        public IDbCommand CreateCommand(IDbConnection connection, string sql, params object[] args)
        {
            ...
            {
                var logs = (List<string>)HttpContext.Current.Items["sqllog"] ?? new List<string>();
                logs.Add(sql);
                HttpContext.Current.Items["sqllog"] = logs;
            }
#endif
        ...
        public virtual void OnExecutedCommand(IDbCommand cmd)
        {
            ...
            if (time.TotalMilliseconds > 3000)
                Himall.Core.Log.Info(string.Format("超时SQL:{0}毫秒,{1}", time.TotalMilliseconds, LastCommand));

            if (System.Web.HttpContext.Current != null)
            {
                var executed = (int)System.Web.HttpContext.Current.Items["MysqlExecuted"];
                executed++;
                System.Web.HttpContext.Current.Items["MysqlExecuted"] = executed;
            }
        }
