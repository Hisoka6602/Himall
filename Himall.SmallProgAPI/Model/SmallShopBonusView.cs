...
{
    public class SmallShopBonusView
    {
        public SmallShopBonusView()
        {

        }

        public SmallShopBonusView(ShopBonusInfo m)
        {
            Id = m.Id;
            Count = m.Count;
            ...
            ShareImg =HimallIO.GetRomoteImagePath(m.ShareImg);
        ...
        public static implicit operator ShopBonusInfo(SmallShopBonusView m)
        {
