    ...
    public class H5AuthorizationAttribute : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            if (!isOpenH5)
            {
                ...
                else if(controllerName== "weixin") {
                    if (!Application.SiteSettingApplication.SiteSettings.IsOpenMallSmallProg&&!Application.SiteSettingApplication.SiteSettings.IsOpenApp)
                    {
                        //跳转到错误页
                        var resultApp = new ViewResult()
                        {
            ...
            if (currentSiteInfo != null)
            {
                ...
                if (areaName == "selleradmin")
                {
                    switch (controllerName)
                    {
                        ...
                        case "collocation":
                            {
                                if (!(currentSiteInfo.IsOpenPC || currentSiteInfo.IsOpenH5 || currentSiteInfo.IsOpenMallSmallProg))
                                {
                                    NoAccess(filterContext);
                                }
                            }
                        ...
                        case "shopbonus":
                            {
                                if (!(currentSiteInfo.IsOpenApp || currentSiteInfo.IsOpenH5 || currentSiteInfo.IsOpenMallSmallProg))
                                {
                                    NoAccess(filterContext);
                                }
                            }
                ...
                else if (areaName == "admin")
                {
                    switch (controllerName)
                    {
                        ...
                        case "bonus":
                            {
                                if (!(currentSiteInfo.IsOpenH5 || currentSiteInfo.IsOpenMallSmallProg))
                                {
                                    NoAccess(filterContext);
                                }
                            }
                        ...
                        case "couponactivity":
                            {
                                if (!(currentSiteInfo.IsOpenH5 || currentSiteInfo.IsOpenPC || currentSiteInfo.IsOpenApp || currentSiteInfo.IsOpenMallSmallProg))
                                {
                                    NoAccess(filterContext);
                                }
                            }
                        ...
                        case "weiactivity":
                            {
                                if (!(currentSiteInfo.IsOpenH5 || currentSiteInfo.IsOpenApp || currentSiteInfo.IsOpenMallSmallProg) && actionName!= "getcouponbyname")
                                {
                                    NoAccess(filterContext);
                                }
                            }
                        ...
                        case "gift":
                            {
                                ...
                                //其余为礼品管理
                                if (!(currentSiteInfo.IsOpenH5 || currentSiteInfo.IsOpenApp || currentSiteInfo.IsOpenPC || currentSiteInfo.IsOpenMallSmallProg))
                                {
