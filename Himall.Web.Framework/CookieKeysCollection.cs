...
namespace Himall.Web.Framework
{
    ...
    public class CookieKeysCollection
    {
        ...
        /// 分销销售员编号
        /// </summary>
        public const string HIMALL_DISTRIBUTION_SPREAD_ID_COOKIE_NAME = "himall-dspreadid";
        /// <summary>
        /// 需要清理分销销售员编号
        /// </summary>
        public const string HIMALL_NEED_CLEAR_DISTRIBUTION_SPREAD_ID_COOKIE_NAME = "himall-needclearspreadid";
        /// <summary>
        /// 不同平台用户key
        /// </summary>
