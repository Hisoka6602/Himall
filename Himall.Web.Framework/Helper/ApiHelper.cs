...
namespace Himall.Web.Framework
{
    public class ApiHelper
    {
        ...
        public static void CheckBaseParamsAndSign(SortedDictionary<string, string> data)
        {
            ...
            if (Application.SiteSettingApplication.SiteSettings.IsTestApi) {
                return;
            }
        ...
        /// 微信小程序手机号转换
        /// </summary>
        /// <param name="decrydata"></param>
        /// <returns></returns>
        public static WxAppletUserPhoneInfo GetAppletUserPhoneInfo(string decrydata)
        {
            if (!string.IsNullOrEmpty(decrydata))
            {
                WxAppletUserPhoneInfo userphoneinfo = JsonConvert.DeserializeObject<WxAppletUserPhoneInfo>(decrydata);
