        ...
        public static List<ProductBrowsedHistoryModel> GetBrowsingProducts(int num, long userId = 0)
        {
            ...
            if (userId == 0)
            {
                var products = ProductManagerApplication.GetProductByIds(productIdList.Select(a => a.ProductId))
                    ...
                    {
                        ImagePath = Core.HimallIO.GetProductSizeImage(a.RelativePath, 1, (int)ImageSize.Size_350),
                        ProductId = a.Id,
            ...
            else
            {
                ...
                model =
                   ...
                   .Select(a => {
                       ...
                       {
                           ImagePath = Core.HimallIO.GetProductSizeImage(product.RelativePath, 1, (int)ImageSize.Size_350),
