...
namespace Himall.Web.Framework
{
    public class OpenAPIHelper
    {
        ...
        public static void CheckBaseParamsAndSign(SortedDictionary<string, string> data)
        {
            if (data == null)
            {
                throw new HimallApiException(Hishop.Open.Api.OpenApiErrorCode.System_Error, "no params");
            }
            if (data.Count < 1)
            {
                throw new HimallApiException(Hishop.Open.Api.OpenApiErrorCode.System_Error, "no params");
            ...
            {
                throw new HimallApiException(Hishop.Open.Api.OpenApiErrorCode.Missing_Timestamp, "timestamp");
            }
            ...
            {
                throw new HimallApiException(Hishop.Open.Api.OpenApiErrorCode.Invalid_Timestamp, "timestamp");
            }
            if (!data.TryGetValue("sign", out sign))
            {
                throw new HimallApiException(Hishop.Open.Api.OpenApiErrorCode.Missing_Signature, "sign");
            }
            ...
            {
                throw new HimallApiException(Hishop.Open.Api.OpenApiErrorCode.Invalid_Signature, "sign");
            }
        }
