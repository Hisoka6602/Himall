        ...
        public static Privileges GetPrivileges<TEnum>()
        {
            ...
            foreach (var field in fields)
            {
                ...
                if (sitesetting != null)
                {
                    ...
                    if (!(sitesetting.IsOpenPC || sitesetting.IsOpenH5||sitesetting.IsOpenMallSmallProg))
                    {
                        if (groupInfo.GroupName == "营销")
                        {
                    ...
                    if (!(sitesetting.IsOpenH5 || sitesetting.IsOpenApp || sitesetting.IsOpenMallSmallProg))
                    {
                        if (groupInfo.GroupName == "营销")
                        {
        ...
        public static Privileges GetPrivileges<TEnum>(AdminCatalogType Type)
        {
            ...
            foreach (var field in fields)
            {
                ...
                if (sitesetting != null)
                {
                    ...
                    if (!sitesetting.IsOpenH5)//H5端未开启授权
                    {
                        if (groupInfo.GroupName == "微商城")
                        {
                            ...
                            if (groupInfo.Name == "菜单设置" && groupInfo.Pid == 10003)
                                continue;
                            if (!sitesetting.IsOpenMallSmallProg) {//未开启小程序端
                    ...
                    if (!sitesetting.IsOpenMallSmallProg)
                    {
                        if (groupInfo.GroupName == "小程序")
                        {
                            ...
                            if (groupInfo.Name == "消息配置" && groupInfo.Pid == 13003)
                                continue;
                            if (groupInfo.Name == "主题颜色" && groupInfo.Pid == 13004)
                                continue;
                            if (groupInfo.Name == "底部导航栏" && groupInfo.Pid == 13005)
                                continue;
                        }
                    }
                    ...
                    if (!(sitesetting.IsOpenH5 || sitesetting.IsOpenApp || sitesetting.IsOpenMallSmallProg))
                    {
                        if (groupInfo.Name == "微店管理" && groupInfo.Pid == 5009)
                            continue;
                    }
