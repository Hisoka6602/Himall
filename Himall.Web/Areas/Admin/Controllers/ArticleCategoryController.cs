    ...
    public class ArticleCategoryController : BaseAdminController
    {
        ...
        public ActionResult Management()
        {
            ...
            if (sitesetting != null)
            {
                ...
                {
                    articleCategories = articleCategories.Where(p => p.Id == SpecialCategory.PlatformNews.GetHashCode()).ToList();//既商家中心的平台公告
                }
            }
        ...
        public JsonResult GetCategories(long? key = null, int? level = -1)
        {
            ...
            if (key.HasValue)
            {
                ...
                if (sitesetting != null)
                {
                    ...
                    {
                        cateoriesPair = cateoriesPair.Where(p => p.Key == SpecialCategory.PlatformNews.GetHashCode());//既商家中心的平台公告
                    }
                }
