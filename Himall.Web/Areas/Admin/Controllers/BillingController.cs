...
namespace Himall.Web.Areas.Admin.Controllers
{
    public class BillingController : BaseAdminController
    {
        ...
        /// <param name="rows"></param>
        /// <returns></returns>
        public ActionResult ExportSettlementList(DateTime? startDate, DateTime? endDate, string shopName)
        {
            if (startDate == null)
