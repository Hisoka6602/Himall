...
namespace Himall.Web.Areas.Admin.Controllers
{
    public class BrandController : BaseAdminController
    {
        ...
        public BrandController(BrandService BrandService, SearchProductService SearchProductService)
        {
        ...
        {
            _iBrandService.AuditBrand(id, Himall.Entities.ShopBrandApplyInfo.BrandAuditStatus.Audited, "");
        ...
        {
            _iBrandService.AuditBrand(id, Himall.Entities.ShopBrandApplyInfo.BrandAuditStatus.Refused, remark);
