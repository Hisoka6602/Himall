...
namespace Himall.Web.Areas.Admin.Controllers
{
    ...
    {
        MobileHomeTopicService _iMobileHomeTopicService;
        SlideAdsService _iSlideAdsService;
        private TopicService _iTopicService;
        public NearShopBranchController(MobileHomeTopicService MobileHomeTopicService, SlideAdsService SlideAdsService, TopicService TopicService)
        {
        ...
        {
            ShopBranchApplication.RecommendShopBranch(ids);
        ...
        {
            ShopBranchApplication.RecommendChangeSequence(oriShopBranchId, newShopBranchId);
            return Json(new Result { success = true }, JsonRequestBehavior.AllowGet);
        }

        public JsonResult ResetShopBranchRecommend(long id)
        {
            ShopBranchApplication.ResetShopBranchRecommend(id);
            return Json(new Result { success = true }, JsonRequestBehavior.AllowGet);
        }
