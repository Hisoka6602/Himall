...
namespace Himall.Web.Areas.Admin.Helper
{
    ...
    {
        private static Dictionary<SpecificationType, Func<TypeInfo, MvcHtmlString>> SpecificationMap = 
            new Dictionary<SpecificationType, Func<TypeInfo, MvcHtmlString>>();
        ...
        private static MvcHtmlString GenerateColor(TypeInfo model)
        {
        ...
        private static MvcHtmlString GenerateSize(TypeInfo model)
        {
            StringBuilder htmlTag = new StringBuilder();
        ...
        private static MvcHtmlString GenerateVersion(TypeInfo model)
        {
            StringBuilder htmlTag = new StringBuilder();
        ...
        public static MvcHtmlString GenerateSpecification(this HtmlHelper _html, TypeInfo model, SpecificationType spec)
        {
