...
function GetData() {
    ...
    $("#list").hiMallDatagrid({
        ...
        pagePosition: 'bottom',
        pageNumber: 1,
        queryParams: { username: username, cellphone: phone, realname: realname },
        columns: [[
            {
                field: "userName", title: '会员帐号/昵称', width: 120,
                formatter: function (value, row, index) {
                    var html = ["<span>" + row.userName + "</span><br/>"];
                    html.push("<span>" + row.nick + "</span>");
                    return html.join("");
                }
            },
