...
function bind() {
    var couponsId = [];
    $("#colist [type='hidden']").each(function () {
        couponsId.push(this.value);
    });
    //优惠券表格
    $("#CouponGrid").hiMallDatagrid({
        ...
        pageSize: 5,
        pageNumber: 1,
        couponsId: couponsId.join(","),
        queryParams: { text: $("#couponName").val(), ReceiveType: 2, page: 1, pageSize: 5, couponsId: couponsId.join(",") },
        columns: [[
            {
