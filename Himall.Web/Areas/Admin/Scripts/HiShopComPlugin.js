...
function CreateDropdown(ele, obj, parameter, clientName,isopenstore) {
    ...
    if (clientName == "vshop") {
        ...
        tempHtml += "<div class=\"dropdown\">\
                                        ...
                                        <span id=\"spLinkTitle\">选择链接</span> <i class=\"caret\"></i></a>\
                                        <ul class=\"dropdown-menu\">\
                                            <li data-val=\"/pages/home/home\"><a href=\"javascript:;\">首页</a></li>\
                                            <li data-val=\"/pages/hotVshopList/hotVshopList\"><a href=\"javascript:;\">微店列表</a></li>\
                                            <li data-val=\"/pages/productcategory/productcategory\"><a href=\"javascript:;\">分类</a></li>\
                                            <li data-val=\"/pages/shopcart/shopcart\"><a href=\"javascript:;\">购物车</a></li>\
                                            <li data-val=\"/pages/usehome/usehome\"><a href=\"javascript:;\">个人中心</a></li>\
                                            <li data-val=\"/pages/livelist/livelist\"><a href=\"javascript:;\">小程序直播</a></li>";
        if (isopenstore == "True") {
            tempHtml += "<li data-val=\"/pages/stores/stores\"><a href=\"javascript:;\">周边门店</a></li>";
        }
