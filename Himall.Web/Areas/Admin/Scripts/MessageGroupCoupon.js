...
function bind() {
    ...
    $("#CouponGrid").hiMallDatagrid({
        ...
        columns:
            ...
            {
                field: "strEndTime", title: "有效期", align: "center", width: 200, formatter: function (value, row, index) {
                    var html = row.strStartTime + '~' + row.strEndTime;
                    return html;
                }
            },
           {
               field: "id", title: '选择', align: "center", width: 50, formatter: function (value, row, index) {
