$(function () {
    ...
    $('#searchButton').click(function (e) {
        ...
        $("#list").hiMallDatagrid('reload', { applyStartTime: applyStartTime, applyEndTime: applyEndTime, auditedStartTime: auditedStartTime, auditedEndTime: auditedEndTime, shopName: shopName });
    });
});
