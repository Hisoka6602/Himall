        ...
        columns:
            [[
                ...
                },
                {
                    ...
                    formatter: function (value, row, index) {
                        var html = "";
                        html += '<input type=\"text\" style=\"border:none;\" id=\"articleUrl' + row.id + '\" value=\"' + row.showurl + '\" /><a class="good-check copyurl" data-clipboard-action=\"copy\" data-clipboard-target="#articleUrl' + row.id + '">复制地址</a>';
                        return html;
                    },
                    styler: function () {
                        return 'td-operate';
