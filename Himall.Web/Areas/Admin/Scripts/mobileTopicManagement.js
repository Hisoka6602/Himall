...
$(function () {
            ...
            },
            {
                ...
                formatter: function (value, row, index) {
                    ...
                    if (row.platform != "小程序") {
                        ...
                        html += '<div style="width:81px;float:right;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>';//div站宽度使对齐
                    }
                    html += "</span>";
                    return html;
                },
    ...
    $('#searchButton').click(function () {
        ...
        var platformType = $('#ddlPlatformType').val();
        $("#topicGrid").hiMallDatagrid('reload', { tagsKeyword: tagsKeyword, titleKeyword: titleKeyword, platformType: platformType });
    });
});
