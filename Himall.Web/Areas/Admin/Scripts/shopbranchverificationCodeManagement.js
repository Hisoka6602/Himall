...
$(function () {
        ...
        $("#list").hiMallDatagrid({
            ...
            columns:
                [[
                    ...
                    { field: "PickupCode", title: "核销码", width: 100, align: "center" },
                    //{ field: "StatusText", title: "状态", width: 100, align: "center" },
                    { field: "PayDatestr", title: "付款时间", width: 100, align: "center" },
                    { field: "FinishDatestr", title: "核销时间", width: 100, align: "center" },
                    { field: "ShopBranchName", title: "商家/门店", width: 100, align: "center" }
    ...
    $('#searchButton').click(function (e) {
        ...
        $("#list").hiMallDatagrid('clearReload', { OrderId: OrderId, Status: Status, PayDateStart: PayDateStart, PayDateEnd: PayDateEnd, VerificationCode: VerificationCode, ShopBranchName: ShopBranchName, VerificationTimeStart: VerificationTimeStart, VerificationTimeEnd: VerificationTimeEnd, SearchId: SearchId, Type: Type });
