...
namespace Himall.Web.Areas.Mobile.Controllers
{
    ...
    public class GiftsController : BaseMobileTemplatesController
    {
        ...
        public GiftsController(ProductService ProductService, TypeService TypeService
            , GiftService GiftService, CouponService CouponService, VShopService VShopService
            , GiftsOrderService GiftsOrderService, MemberGradeService MemberGradeService)
        {
        ...
        public ActionResult Index()
        {
            ...
            //积分优惠券
            var coupons = _CouponService.GetIntegralCoupons(1, 3);
