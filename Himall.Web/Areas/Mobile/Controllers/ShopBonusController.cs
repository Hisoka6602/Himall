...
namespace Himall.Web.Areas.Mobile.Controllers
{
    ...
    {
        private ShopBonusService _bonusService = null;
        private WXCardService _WXCardService = null;
        ...
        public ShopBonusController(ShopBonusService ShopBonusService,
            ...
            )
        {
            ...
            this._bonusService = ShopBonusService;
        ...
        public ActionResult Index(long id)
        {
            ...
            {
                string selfAddress = WebHelper.GetUrl();
        ...
        public JsonResult GetWXCardData(long id, long rid)
        {
            ...
            if (isdataok)
            {
                ...
                {
                    result = _WXCardService.GetJSWeiXinCard(id, rid, ThisCouponType);
                }
            }
            #endregion
        ...
        public ActionResult Completed(long id, string openId = "", decimal price = 0, string user = "", long grantid = 0, long rid = 0, string wxhead = "", string host = "")
        {
            ...
            {
                model.WXJSInfo = _WXCardService.GetSyncWeiXin(id, rid, ThisCouponType, WebHelper.GetAbsoluteUri());
        ...
        public ActionResult GetOtherReceive(long id)
        {
            ...
            foreach (var re in result)
            {
                ...
                {
                    Name = re.WXName,
                    HeadImg = (!string.IsNullOrEmpty(re.WXHead) && re.WXHead.IndexOf("http://") == -1 && re.WXHead.IndexOf("https://") == -1) ? HimallIO.GetImagePath(re.WXHead) : re.WXHead,
        ...
        {
            var result = _VShopService.GetVShopByShopId(shopid);
            if (result == null)
            {
                return "/";
            }
        ...
        private UserInfoJson GetWXUserHead(string openid)
        {
            ...
            {
                string accessToken = WXApiApplication.TryGetToken(siteSetting.WeixinAppId, siteSetting.WeixinAppSecret);
