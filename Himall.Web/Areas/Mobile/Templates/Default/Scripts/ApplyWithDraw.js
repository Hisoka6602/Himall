...
$('#submitPayBtn').click(function () {
    ...
    {
        var loading = showLoading();
        $.post('/' + areaName + '/Capital/Charge', { pluginId: 'Himall.Plugin.Payment.WeiXinPay', amount: amount, ispresent: ispresent },
            function (data) {
                loading.close();
...
$('#weixinpay').click(function () {
    ...
    var amount = $('#chargeAmount').val();
    var loading = showLoading();
    $.post('/' + areaName + '/Capital/Charge', { pluginId: 'Himall.Plugin.Payment.WeiXinPay_H5', amount: amount, ispresent: ispresent },
        function (data) {
            loading.close();
            if (data.success == true) {
                $('#rechargePay').hide();
...
$('#alipay').click(function () {
    ...
    var amount = $('#chargeAmount').val();
    var loading = showLoading();
    $.post('/' + areaName + '/Capital/Charge', { pluginId: 'Himall.Plugin.Payment.Alipay_WAP', amount: amount, ispresent: ispresent },
        function (data) {
            loading.close();
            if (data.success == true) {
                $('#rechargePay').hide();
