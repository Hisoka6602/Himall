...
$(function () {
    ...
    returnFavoriteHref = "/" + areaName + "/branchproduct/Detail/" + pid + "?shopBranchId=" + getQueryString("shopBranchId");
...
function AddCartHtml(obj, buynum) {
    ...
    if ($("#addcartobj").length == 0) {
        $(obj).before("<div class=\"wrap-num store-num\" id=\"addcartobj\">" +
...
function editcart(numObj) {
    ...
    if (len === $(".spec").length) {
        returnHref = "/" + areaName + "/branchproduct/Detail/" + pid + "?shopBranchId=" + getQueryString("shopBranchId");
...
function ShowCoupon(shopId) {
    ...
    var returnurl = "/" + areaName + "/branchproduct/Detail/" + pid + "?shopBranchId=" + getQueryString("shopBranchId");
