    ...
    $(sbottom).find("button").click(function () {
        ...
        checkLogin(returnHref, function () {
            if (!$(this).hasClass("disabled")) {
                ...
                var url = '/common/site/pay?area=mobile&platform=' + areaName.replace('m-', '') + '&controller=BranchOrder&action=SubmiteByCart&cartItemIds={0}&shopBranchId={1}'.format(itemId.substr(0, itemId.length - 1), bid);
