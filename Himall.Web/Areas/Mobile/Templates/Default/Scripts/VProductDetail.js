...
$(function () {
    ...
    returnFavoriteHref = "/" + areaName + "/branchproduct/vdetails/" + pid + "?shopBranchId=" + getQueryString("shopBranchId");
...
function easybuy() {
    ...
    if (len === $(".spec").length) {
        returnHref = "/" + areaName + "/branchproduct/vdetails/" + pid + "?shopBranchId=" + getQueryString("shopBranchId");
...
function ShowCoupon(shopId) {
    ...
    var returnurl = "/" + areaName + "/branchproduct/vdetails/" + pid + "?shopBranchId=" + getQueryString("shopBranchId");
