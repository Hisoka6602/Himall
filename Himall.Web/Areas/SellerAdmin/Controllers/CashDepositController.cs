...
namespace Himall.Web.Areas.SellerAdmin.Controllers
{
    public class CashDepositController : BaseSellerController
    {
        ...
        public JsonResult PaymentList(decimal balance)
        {
            ...
            models = models.Where(item => !string.IsNullOrEmpty(item.RequestUrl) && item.Id != "Himall.Plugin.Payment.WeiXinPay");//只选择正常加载的插件  && item.Id != "Himall.Plugin.Payment.WeiXinPay_Native"
            return Json(models);
        }
