...
namespace Himall.Web.Areas.SellerAdmin.Controllers
{
    ...
    public class FightGroupController : BaseSellerController
    {
        ...
        public FightGroupController(LimitTimeBuyService LimitTimeBuyService)
        {
        ...
        public JsonResult AddActive(FightGroupActiveModel model)
        {
            ...
            foreach (var item in model.ActiveItems)
            {
                ...
                if (cursku != null)
                {
                    ...
                    {
                        throw new HimallException(item.SkuName + "错误的活动库存");
                    }
                }
                else
                {
            ...
            if (ModelState.IsValid)
            {
                ...
                ProductManagerApplication.SaveProdcutActivty(model.ProductId, CurrentShop.Id,ProductInfo.ProductActiveType.Group,data.Id);
        ...
        public JsonResult CanAdd(long productId)
        {
            ...
            {
                if (_LimitTimeBuyService.IsAdd(productId))
                {
                    result.success = true;
                    result.msg = "";
                }
        ...
        public ActionResult EditActive(long id)
        {
            ...
            {
                throw new HimallException("已结束的活动不可以编辑");
            }
            return View(model);
        }
        /// <summary>
        ...
        {
            FightGroupApplication.DisableActivity(id, CurrentShop.Id);
