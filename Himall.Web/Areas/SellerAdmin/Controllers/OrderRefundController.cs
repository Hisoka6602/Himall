...
namespace Himall.Web.Areas.SellerAdmin.Controllers
{
    public class OrderRefundController : BaseSellerController
    {
        ...
        public JsonResult DealRefund(long refundId, int auditStatus, string sellerRemark)
        {
            ...
            _RefundService.SellerDealRefund(refundId, refundauditstatus, sellerRemark, CurrentSellerManager.UserName);
            result.success = true;
            return Json(result);
        }
        ...
        public JsonResult ConfirmRefundGood(long refundId)
        {
            ...
            try
            {
                _RefundService.SellerConfirmRefundGood(refundId, CurrentSellerManager.UserName);
                result.success = true;
            }
            catch (Exception ex)
            {
