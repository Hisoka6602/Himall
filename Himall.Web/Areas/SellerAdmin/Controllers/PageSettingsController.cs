...
namespace Himall.Web.Areas.SellerAdmin.Controllers
{
    ...
    public class PageSettingsController : BaseSellerController
    {
        ...
        public PageSettingsController(SlideAdsService SlideAdsService, ShopService ShopService)
        {
        ...
        public JsonResult GetlimitTimeProducts(LimitTimeQuery query)
        {
            ...
            var result = ObjectContainer.Current.Resolve<LimitTimeBuyService>().GetFlashSaleInfos(query);
        ...
        public JsonResult GetCoupons(int page = 1, string title = "")
        {
            ...
            var couponsList = ObjectContainer.Current.Resolve<CouponService>().GetCouponList(new
           Himall.DTO.QueryModel.CouponQuery
            {
                ...
                IsShowAll = false,
                ShowPlatform = Himall.Core.PlatformType.PC,
                PageNo = page,
                PageSize = 10
            });
