...
namespace Himall.Web.Areas.SellerAdmin.Controllers
{
    ...
    {
        private PoiService _iPoiService;
        private VShopService _VShopService;
        private Entities.WXshopInfo _settings;
        bool _isdeploy = true;

        public PoiController(PoiService PoiService, VShopService VShopService)
        {
            _VShopService = VShopService;
            if (CurrentSellerManager != null)
            {
                this._settings = _VShopService.GetVShopSetting(CurrentSellerManager.ShopId);
                if (this._settings != null)
                {
                    this._iPoiService = PoiService;
                    try
                    {
