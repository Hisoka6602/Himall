...
namespace Himall.Web.Areas.SellerAdmin.Controllers
{
    public class ProductCommentController : BaseSellerController
    {
        ...
        {
            bool isReply = WebHelper.GetAbsoluteUri().ToLower().Contains("selleradmin/home/console");
        ...
        public JsonResult List(int page, int rows, string productName, bool? isReply = null, int Rank = -1, bool hasAppend = false)
        {
            ...
            {
                string picimg=Core.HimallIO.GetProductSizeImage(item.ImagePath, 1, (int)ImageSize.Size_100);
                if (item.ImagePath.Contains("skus")) {
                    picimg = HimallIO.GetImagePath(item.ImagePath);
                }
                item.ImagePath = picimg;
        ...
        public JsonResult ReplyComment(long id, string replycontent, string appendContent)
        {
            ...
            _CommentService.ReplyComment(id, shopid, replycontent, appendContent);
