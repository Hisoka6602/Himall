...
namespace Himall.Web.Areas.SellerAdmin.Controllers
{
    ...
    {
        private ShopBonusService _bonusService;
        private MarketService _MarketService;
        public ShopBonusController(ShopBonusService ShopBonusService, MarketService MarketService)
        {
        ...
        {
            var settings = _MarketService.GetServiceSetting(MarketType.RandomlyBonus);
            if (settings == null)
            {
                return View("UnSet");
            }
        ...
        public ActionResult BuyService()
        {
            ...
            var active = _MarketService.GetServiceSetting(MarketType.RandomlyBonus);
            model.IsNo = true;
            string endDate = null;
