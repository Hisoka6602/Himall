        ...
        $.post('/Common/ExpressData/Search', { expressCompanyName: ExpressCompanyName, shipOrderNumber: ShipOrderNumber, orderId: oid }, function (result) {
            ...
            if (obj.success) {
                ...
                if (ExpressCompanyName.indexOf('顺丰') == 0) {
                    html += '<div class="form-group clearfix" style="text-align:center;font-size:16px;">暂无物流信息，请稍后再试；如有信息推送不及时，请前往物流官网查询！<a class="express-link" href="http://www.sf-express.com/cn/sc/dynamic_function/waybill/#search/bill-number/' + ShipOrderNumber + '" target="_blank">顺丰官网查询</a></div>';
                } else {
