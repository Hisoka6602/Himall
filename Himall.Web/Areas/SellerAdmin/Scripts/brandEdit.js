...
function EditApply() {
    ...
    if (mode == "1") {
        ...
        var brandLetter = $('#brandLetter').himallUpload('getImgSrc').toString(),
        ...
        var pic = $("#brandPic").himallUpload('getImgSrc').toString(),
        authpic = $("#brandAuthPic").himallUpload('getImgSrc').toString(),
        name = $('#band_name').val(),
        des = $('#band_des').val();
        var reg = /^[a-zA-Z0-9\u4e00-\u9fa5]+$/;
