...
$(function () {
    ...
    datacols = [[
        ...
        { field: "ApplyDate", title: "申请日期", width: 80, align: "center" },
            ...
            {
                field: "Amount", title: "退款金额", width: 80, align: "center",
                formatter: function (value, row, index) {
                    return '￥' + value;
                }
            }]];
    ...
    $('#searchButton').click(function (e) {
        ...
        $("#list").hiMallDatagrid('clearReload', { startDate: startDate, endDate: endDate, orderId: orderId, productName: productName, userName: userName, shopBranchId: shopBranchId, auditStatus: status });
    })
    ...
    $('.nav-tabs-custom li').click(function (e) {
        ...
        if ($(this).attr('type') == 'statusTab') {//状态分类
            ...
            $("#list").hiMallDatagrid('clearReload', { auditStatus: status });
        }
    });
});
