...
$(function () {
    ...
    $('#searchButton').click(function (e) {
        ...
        $("#list").hiMallDatagrid('clearReload', { OrderId: OrderId, Status: Status, PayDateStart: PayDateStart, PayDateEnd: PayDateEnd, VerificationCode: VerificationCode, ShopBranchId: ShopBranchId, VerificationTimeStart: VerificationTimeStart, VerificationTimeEnd: VerificationTimeEnd });
    });
});