...
namespace Himall.Web.Areas.Web.Controllers
{
    public class UserIntegralController : BaseMemberController
    {
        ...
        public UserIntegralController(GiftsOrderService GiftsOrderService, MemberIntegralService MemberIntegralService)
        {
        ...
        #region 礼品订单
        public ActionResult OrderList(string skey, Himall.Entities.GiftOrderInfo.GiftOrderStatus? status, int page = 1)
        {
            int rows = 12;
