...
namespace Himall.Web.Areas.Web.Models
{
    public class ProductDetailModelForWeb
    {
        ...
        public DTO.ProductEnsure CashDepositsServer { get; set; }
        ...
        public DTO.ProductEnsure CashDepositsObligation { get; set; }
    ...
    public class LimitTimeProductDetailModel : ProductDetailModelForWeb
    {
        ...
        public DTO.ProductEnsure CashDeposits { get; set; }
