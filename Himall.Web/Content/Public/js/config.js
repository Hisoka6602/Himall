...
$(function () {
    ...
    HiShop.Config.AjaxUrl = {
        ...
        Category: "/Admin/TemplateVisualizationAjax/Hi_Ajax_Categorys",//选择分类
        /*商品相关 end*/
		/*直播相关 start*/
		LivesList: "/Admin/TemplateVisualizationAjax/Hi_Ajax_GetLivesList",//直播间列表
		/*直播相关 end*/
        gamesUrl: "/Admin/TemplateVisualizationAjax/Hi_Ajax_GetGames",
        ShopList: "/Admin/TemplateVisualizationAjax/Hi_Ajax_Shops",//选择店铺
        ShopBrachAllTags: "/Admin/TemplateVisualizationAjax/Hi_Ajax_GetAllShopBranchTags",//所有门店标签
        ShopBrachTagList: "/Admin/TemplateVisualizationAjax/Hi_Ajax_GetShopBranchTags",//选择门店标签
        ShopBrachList: "/Admin/TemplateVisualizationAjax/Hi_Ajax_GetShopBranchList",//选择单个门店
        BrandList: '/Admin/TemplateVisualizationAjax/Hi_Ajax_SmallProgBrand',//获取品牌列表
        ArticleList: '/Admin/TemplateVisualizationAjax/Hi_Ajax_ArticleList'//获取文章列表
    }
