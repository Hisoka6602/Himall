...
HiShop.Constant = HiShop.Constant ? HiShop.Constant : {},
	...
	HiShop.popbox.LivesPicker = function (a, b, old) {
	    var c, d, e = $("#tpl_popbox_LivesPicker").html(),
	        f = $(e),
	        g = old,
	        h = [],
	        i = function (a, b) {
	            var d = function (a) {
	                if (c = a.list, c && c.length) {
	                    var d = $("#tpl_popbox_LivesPicker_goodsitem").html(),
	                        e = _.template(d, {
	                            dataset: c
	                        }),
	                        j = $(e);
	                    j.find(".j-select").click(function () {
	                        ...
	                        if (a = "" != i ? i.split(",") : [], d.hasClass("selected")) {
	                            ...
	                            var maxCount = parseInt($("#lblMaxCount").html()); //该限定值只在商品详情可视化中才有
	                            if (maxCount > 0 && old != null) {
	                                var _ids = [];
	                                //页面上已选直播间
	                                $.each(old, function (i, val) {
	                                    _ids.push(val.RoomId);
	                                });
	                                //弹框已选直播间
	                                for (i = 0, len = g.length; i < len; i++) {
	                                    if ($.inArray(g[i].RoomId, _ids) < 0) {
	                                        _ids.push(g[i].RoomId);
	                                    }
	                                }
	                                // 去重
	                                $.unique(_ids);
	                                //合并后的直播间
	                                g.length = _ids.length;
	                            }
	                            if (g.length > maxCount - 1) {
	                                alert("最多选" + maxCount + "个直播间");
	                                return;
	                            }
	                ...
	                var m = [];
	                "" != $(".j-verify").val() ? m = ($(".j-verify").val() ? $(".j-verify").val().split(",") : []) : $(".img-list li").not(".img-list-add").each(function (a, b) {
	            ...
	            $.ajax({	
	                url: HiShop.Config.AjaxUrl.LivesList,
	                type: "post",
	                dataType: "json",
	                data: {
	                    p: parseInt(a),
	                    franchiseeId: $('#vfranchiseeId').val()
	                },
	                success: function (a) {
	                    //1 == a.status ? d(a) : HiShop.hint("danger", "对不起，获取数据失败：" + a.msg)
	                    a.list ? d(a) : HiShop.hint("danger", "对不起，获取数据失败：" + '未找到直播间')
	                }
	            })
	        },
	        j = function (a, b) {
	            var c = function (a) {
	                if (d = a.list, d && d.length) {
	                    var c = $("#tpl_popbox_LivesPicker_groupitem").html(),
	                        e = _.template(c, {
	                            dataset: d
	                        }),
	                        g = $(e);
	    ...
	    switch (a) {
	    	case "goodsMulti":
	            ...
	            f.find(".gagp-goodslist").unwrap().unwrap(),
	                ...
	                i(1,
	                    function () {
	                        var b = '<span class="fl">选择直播间</span><div class="goodsearch"><input type="text" class="goodsname" name="name" placeholder="请输入直播标题" /><a href="javascript:;" class="btn btn-primary jGetLive"><i class="gicon-search white"></i>查询</a></div>';
	                        $.jBox.show({
	                            title: b,
	                            content: f,
	                            btnOK: {
	                                            ...
	                                            e = function (a, i) {
	                                                ...
	                                                var j = function (a) {
	                                                    if (c = a.list, c && c.length) {
	                                                        ...
	                                                        var b = $("#tpl_popbox_LivesPicker_goodsitem").html(),
	                                                            d = _.template(b, {
	                                                                dataset: c
	                                                            }),
	                                                            j = $(d);
	                                                ...
	                                                $.ajax({
	                                                    ...
	                                                    success: function (a) {
	                                                        ...
	                                                        a.list ? j(a) : HiShop.hint("danger", "对不起，获取数据失败：" + a.msg)
	                                                    }
	                                                })
	                                            };
	                                        e()
    ...
    HiShop.popbox.GoodsAndGroupPicker = function (a, b, old, url) {
        ...
        var c, d, e = $("#tpl_popbox_GoodsAndGroupPicker").html(),
            ...
            i = function (a, b) {
                ...
                $.ajax({
                    ...
                    url: url ? url : HiShop.Config.AjaxUrl.GoodsList,
                    type: "post",
                    dataType: "json",
                    data: {
                        p: parseInt(a),
                        ...
                        function () {
                            ...
                            $.jBox.show({
                                ...
                                onOpen: function (b) {
                                    ...
                                    //xlx新增商家、分类搜索条件
                                    $('.goodsearch select').himallLinkage({
                                        url: HiShop.Config.AjaxUrl.goodGroup,
                                        ...
                                        onChange: function (level, value) {
                                            ...
                                            if (level > 0 && !value) {
                                                ...
                                                categoryId = $('.goodsearch select').himallLinkage('value', parentLevel);
        ...
        var c, d, e = $("#tpl_popbox_CouponPicker").html(),
            ...
            i = function (a, b) {
                var d = function (a) {
                    ...
                    var m = [];
                    undefined != $(".j-verify").val() && "" != $(".j-verify").val() ? m = $(".j-verify").val().split(",") : $(".img-list li").not(".img-list-add").each(function (a, b) {
                        var c = $(this).data("item");
                        m.push(c)
                    }),
                        f.find(".tr_li").each(function (a, b) {
    ...
    HiShop.popbox.dplPickerColletion = function (a) {
        ...
        switch (parseInt(c.linkType)) {
            ...
            case 6: //限时购列表
                var d = {
                    title: "限时购列表",
                    link: "/pages/countdown/countdown"
                };
                c.callback(d, 6);
                break;
            case 9: //拼团列表
                var d = {
                    title: "拼团列表",
                    link: "/pages/grouplist/grouplist"
                };
                c.callback(d, 9);
                break;
            case 7: //签到
            ...
            case 15: //商家入驻
                var d = {
                    title: "商家入驻",
                    link: "/pages/shopRegisterStep1/shopRegisterStep1"
                };
                c.callback(d, 15);
                break;
            case 16: //周边门店
            ...
            case 24: //积分商城
                var d = {
                    title: "积分商城",
                    link: "/pages/pointsShoppingCenter/pointsShoppingCenter"
                };
                c.callback(d, 24);
                break;
            case 26://分类
            ...
            case 29://微店
                var d = {
                    title: "微店",
                    link: "../hotVshopList/hotVshopList"
                };
                c.callback(d, 29);
                break;
            case 30: //选择分类
                HiShop.popbox.CategoryPicker("all", c.callback);
                break;
            case 31: //选择店铺
                HiShop.popbox.ShopPicker("all", c.callback);
                break;
            case 32://小程序直播
                var d = {
                    title: "小程序直播",
                    link: "../livelist/livelist"
                };
                c.callback(d, 32);
                break;
            case 33: //门店标签
                HiShop.popbox.ShopBranchTagPicker("all", c.callback);
                break;
            case 34: //单个门店
                HiShop.popbox.ShopBranchSinglePicker("all", c.callback);
                break;
            case 40: //品牌列表
                HiShop.popbox.BrandPicker("all", c.callback);
                break;
            case 41: //文章列表
                var d = {
                    title: "文章列表",
                ...
                break;
            case 42: //选择文章
                HiShop.popbox.ArticleDetailPicker("all", c.callback);
                break;
        }
    },
    HiShop.ajaxPopTable = function (a) {
                ...
                if (!f.length) {
                    ...
                    a.ajax({
                        ...
                        o.click(function () {
						 ...
						 l.change(function () {
                            var carid= Cache.folderID==-1 ? 0 : Cache.folderID;
                             var myform = $('<form action="' + HiShop.Config.AjaxUrl.addImg + "&" + HiShop.getAreaName() + "&cate_id=" + carid + '" method="post" enctype="multipart/form-data" style="display:none"></form>');
						 	$(this).clone(true).appendTo(myform);
                             $('body').append(myform);
						 	myform.ajaxSubmit({
						 		success: function (data) {
						 			data = JSON.parse(data)
						 			if (data.state != 'SUCCESS') {
						 				HiShop.hint("danger", "上传失败：" + data.state)
						 			} else {
						 				myform.remove();
						 				GetImgList(f, Cache.folderID, 1),
                                            UpdateTreeNums(f)
...
//选择店铺
HiShop.popbox.ShopPicker = function (a, b) {
    var c, d, e = $("#tpl_popbox_ShopPicker").html(),
        f = $(e),
        g = [],
        h = [],
        i = function (a, b) {
            var d = function (a) {
                if (c = a.list, c && c.length) {
                    var d = $("#tpl_popbox_ShopPicker_item").html(),
                        e = _.template(d, {
                            dataset: c
                        }),
                        j = $(e);
            ...
            $.ajax({
                ...
                url: HiShop.Config.AjaxUrl.ShopList,
                type: "post",
                dataType: "json",
                data: {
                    p: parseInt(a),
    ...
    switch (a) {
        case "all":
            f.find(".gagp-goodslist").unwrap().unwrap(),
                i(1,
                    function () {
                        var b = '<span class="fl">选择店铺</span><div class="goodsearch"><input type="text" name="title" placeholder="请输入店铺名称" /><a href="javascript:;" class="btn btn-primary jGetshop"><i class="gicon-search white"></i>查询</a></div>';
                        $.jBox.show({
                            title: b,
                            content: f,
                            btnOK: {
                                ...
                                $(document).on("click", ".jGetshop",
                                    function (a) {
                                        ...
                                        e = function (a, i) {
                                            ...
                                            var j = function (a) {
                                                if (c = a.list, c && c.length) {
                                                    var b = $("#tpl_popbox_ShopPicker_item").html(),
                                                        d = _.template(b, {
                                                            dataset: c
                                                        }),
                                                        j = $(d);
    ...
    //选择分类
    HiShop.popbox.CategoryPicker = function (a, b) {
        var c, d, e = $("#tpl_popbox_CategoryPicker").html(),
            f = $(e),
            g = [],
            h = [],
            i = function (a, b) {
                var d = function (a) {
                    if (c = a.list, c && c.length) {
                        var d = $("#tpl_popbox_CategoryPicker_item").html(),
                            e = _.template(d, {
                                dataset: c
                            }),
                            j = $(e);
            ...
            l = function (a) {
                ...
                f.find(".j-btn-goodsuse").remove(),
                    f.on("click", ".gagp-goodslist .j-select",
                        function () {
                            var e = $("#category1").get(0).options.selectedIndex;
                            b && b(c[e], d),
                                $.jBox.close(a)
                        })
            }
    ...
    //选择门店标签
    HiShop.popbox.ShopBranchTagPicker = function (a, b) {
        var c, d, e = $("#tpl_popbox_ShopBranchTagPicker").html(),
            f = $(e),
            g = [],
            h = [],
            i = function (a, b) {
                var d = function (a) {
                    if (c = a.list, c && c.length) {
                        var d = $("#tpl_popbox_ShopBranchTagPicker_item").html(),
                            e = _.template(d, {
                                dataset: c
                            }),
                            j = $(e);
                ...
                $.ajax({
                    ...
                    url: HiShop.Config.AjaxUrl.ShopBrachTagList,
                    type: "post",
                    dataType: "json",
                    data: {
                        p: parseInt(a),
        ...
        switch (a) {
            case "all":
                f.find(".tabs").remove(),
                    ...
                    i(1,
                        function () {
                            var b = '<span class="fl">选择门店标签</span><div class="goodsearch"><input type="text" name="title" placeholder="请输入门店标签名称" /><a href="javascript:;" class="btn btn-primary jGetgood"><i class="gicon-search white"></i>查询</a></div>';
                            $.jBox.show({
                                title: b,
                                content: f,
                                btnOK: {
                                    ...
                                    $(document).on("click", ".jGetgood",
                                        function (a) {
                                            ...
                                            e = function (a, i) {
                                                ...
                                                var j = function (a) {
                                                    if (c = a.list, c && c.length) {
                                                        var b = $("#tpl_popbox_ShopBranchTagPicker_item").html(),
                                                            d = _.template(b, {
                                                                dataset: c
                                                            }),
                                                            j = $(d);
    ...
    //门店列表选择单个门店
    HiShop.popbox.ShopBranchSinglePicker = function (a, b) {
        var c, d, e = $("#tpl_popbox_ShopBranchSinglePicker").html(),
            f = $(e),
            g = [],
            h = [],
            i = function (a, b) {
                var d = function (a) {
                    if (c = a.list, c && c.length) {
                        var d = $("#tpl_popbox_ShopBranchSinglePicker_item").html(),
                            e = _.template(d, {
                                dataset: c
                            }),
                            j = $(e);
                ...
                $.ajax({
                    ...
                    url: HiShop.Config.AjaxUrl.ShopBrachList,
                    type: "post",
                    dataType: "json",
                    data: {
                        p: parseInt(a),
        ...
        switch (a) {
            case "all":
                f.find(".tabs").remove(),
                    ...
                    i(1,
                        function () {
                            var b = '<span class="fl">选择门店--</span><div class="goodsearch"><div id="shopaddress" style="float:left;"><span style="float:left;">区域:</span><div id="area-selectorAd" style="float:left;"></div></div><div style="float:left;margin-left:20px;"><span style="float:left;">标签:</span><select id="shopalltags"><option>请选择</option></select></div><div style="float:left;"><span style="float:left;">名称:</span><input type="text" id="singleShopName" name="title" placeholder="请输入门店名称" /></div><a href="javascript:;" class="btn btn-primary jGetgood" style="margin-left:20px;"><i class="gicon-search white"></i>查询</a></div>';
                            $.jBox.show({
                                title: b,
                                content: f,
                                width: 700,
                                ...
                                onOpen: function (b) {
                                    ...
                                    //地区
                                    $("#shopaddress #area-selectorAd").RegionSelector({
                                        selectClass: "input-sm select-sort-auto",
                                        valueHidden: "#hidAddressIdAd",
                                        maxLevel: 2
                                    });

                                    //门店全部标签
                                    $.ajax({
                                        url: HiShop.Config.AjaxUrl.ShopBrachAllTags,
                                        type: "post",
                                        dataType: "json",
                                        data: { platform: PlatFormType},
                                        success: function (taga) {
                                            var strhtml = '<option value="0">请选择..</option>';
                                            if (taga != null && taga.length > 0) {
                                                for (var i = 0; i < taga.length; i++) {
                                                    strhtml += '<option value="' + taga[i].Id + '">' + taga[i].Title + '</option>';
                                                }
                                            }
                                            $("#shopalltags").html(strhtml);
                                        }
                                    })
                                    ...
                                    $(document).on("click", ".jGetgood",
                                        function (a) {
                                            ...
                                            var b = $("#singleShopName").val();

                                            e = function (a, i) {
                                                a = a ? a : 1;
                                                var j = function (a) {
                                                    if (c = a.list, c && c.length) {
                                                        var b = $("#tpl_popbox_ShopBranchSinglePicker_item").html(),
                                                            d = _.template(b, {
                                                                dataset: c
                                                            }),
                                                            j = $(d);
                                                ...
                                                $.ajax({
                                                    ...
                                                    data: {
                                                        p: parseInt(a),
                                                        titleKeyword: b,
                                                        tagsId: $("#shopalltags").val(),
                                                        addressId: $("#hidAddressIdAd").val(),
                                                        platform: PlatFormType
                                                    },
                                                    success: function (a) {
                                                        1 == a.status ? j(a) : HiShop.hint("danger", "没有查询到数据！")
                                                    }
                                                })
                                            };
                                            e()
    ...
    //选择品牌专题
    HiShop.popbox.BrandPicker = function (a, b) {
    var c, d, e = $("#tpl_popbox_BrandPicker").html(),
            f = $(e),
            g = [],
            h = [],
            i = function (a, b) {
                var d = function (a) {
                    if (c = a.list, c && c.length) {
                        var d = $("#tpl_popbox_BrandPicker_item").html(),
                            e = _.template(d, {
                                dataset: c
                            }),
                            j = $(e);
                ...
                $.ajax({
                    ...
                    url: HiShop.Config.AjaxUrl.BrandList,
                    type: "post",
                    dataType: "json",
                    data: {
                        p: parseInt(a),
                                    ...
                                    $(document).on("click", ".jGetgood",
                                        function (a) {
                                            ...
                                            e = function (a, i) {
                                                ...
                                                var j = function (a) {
                                                    if (c = a.list, c && c.length) {
                                                        var b = $("#tpl_popbox_BrandPicker_item").html(),
                                                            d = _.template(b, {
                                                                dataset: c
                                                            }),
                                                            j = $(d);
    ...
    //文章详情
    HiShop.popbox.ArticleDetailPicker = function (a, b) {
        var c, d, e = $("#tpl_popbox_ArticleDetailPicker").html(),
            f = $(e),
            g = [],
            h = [],
            i = function (a, b) {
                var d = function (a) {
                    if (c = a.list, c && c.length) {
                        var d = $("#tpl_popbox_ArticleDetailPicker_item").html(),
                            e = _.template(d, {
                                dataset: c
                            }),
                            j = $(e);
        ...
        switch (a) {
            case "all":
                f.find(".tabs").remove(),
                    ...
                    i(1,
                        function () {
                            var b = '<span class="fl">选择文章</span><div class="goodsearch"><input type="text" name="title" placeholder="请输入文章标题" /><a href="javascript:;" class="btn btn-primary jGetgood"><i class="gicon-search white"></i>查询</a></div>';
                            $.jBox.show({
                                title: b,
                                content: f,
                                btnOK: {
