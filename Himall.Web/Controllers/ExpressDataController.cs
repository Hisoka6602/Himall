...
namespace Himall.Web.Controllers
{
    public class ExpressDataController : BaseController
    {
        ...
        public ExpressDataController(ExpressService ExpressService)
        {
            _ExpressService = ExpressService;
        }
        // GET: ExpressData
        public JsonResult Search(string expressCompanyName, string shipOrderNumber,long orderId)
        {
            ...
            var expressData = _ExpressService.GetExpressData(expressCompanyName, shipOrderNumber, orderId.ToString(), order == null ? "" : order.CellPhone);
        ...
        // GET: ExpressData
        public JsonResult SearchTop(string expressCompanyName, string shipOrderNumber, long orderId)
        {
            var order = OrderApplication.GetOrder(orderId);
            var expressData = _ExpressService.GetExpressData(expressCompanyName, shipOrderNumber, orderId.ToString(), order == null ? "" : order.CellPhone);
        ...
        public JsonResult SaveExpressData(string param)
        {
            ...
            try
            {
                ...
                _ExpressService.SaveExpressData(model);
