...
namespace Himall.Web.Models
{
    ...
    public class ShopModel
    {
        ...
        /// 订单支付是否发短信通知
        /// </summary>
        public bool OrderPayIsSendSMS { get; set; }
            ...
            : this()
        {
            ...
            var obj = ObjectContainer.Current.Resolve<ShopService>().GetShopGrade(m.GradeId);
            ...
            this.CompanyRegion = ObjectContainer.Current.Resolve<RegionService>().GetFullName(m.CompanyRegionId);
            ...
            this.OrderPayIsSendSMS = m.OrderPayIsSendSMS;
            ...
            this.BusinessLicenceRegionId = ObjectContainer.Current.Resolve<RegionService>().GetFullName(m.BusinessLicenceRegionId);
            ...
            this.BankRegionId = ObjectContainer.Current.Resolve<RegionService>().GetFullName(m.BankRegionId);
