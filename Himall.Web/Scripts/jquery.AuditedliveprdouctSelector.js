...
$.productSelector = {
    params: { auditStatus: 2, saleStatus: 1, selectedProductIds: [], isShopCategory: false, exceptProductIds: [], productType: -1, IsLiveAuditedProduct: false, RoomId: 0 },
    serviceType: 'selleradmin',
    multiSelect: true,
    selectedProducts: [],
    controller: '',
    ...
    loadedProducts: null,
    InLiveProductLibaray: null,
    reload: function (selectedProductIds, exceptProductIds) {

        this.loadedProducts = [];

        url = "/SellerAdmin/Live/GetShopAuditedLiveProducts";
        ...
        $("#_productSelector table").hiMallDatagrid({
            ...
            InLiveProductLibaray: this.InLiveProductLibaray,
            RoomId: this.RoomId,
            columns: [columns]
        });
    ...
    clear: function () {
        ...
        this.params = { auditStatus: 2, saleStatus: 1, selectedProductIds: [], isShopCategory: shopCategory, productType: -1 };
    },
    ...
    show: function (selectedProductIds, onSelectFinishedCallBack, serviceType, multiSelect, exceptProductIds, operationButtons, controller, isInLiveProductLibaray) {
        ...
        this.InLiveProductLibaray = isInLiveProductLibaray;
        $.dialog({
            title: '商品选择',
            lock: true,
            content: this.html,
