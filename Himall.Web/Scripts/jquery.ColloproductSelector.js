...
',
    ...
    reload: function (selectedProductIds, exceptProductIds) {
        ...
        if (this.controller == 'coupon') {
            ...
            $.productSelector.params.isFilterPromotion = false;
        }
        var columns = [
        ...
        if (selectedProductIds) {
            $.post(url, { Ids: selectedProductIds.toString(), page: 1, rows: selectedProductIds.length, showSku: true, isFilterPromotion:false }, function (products) {
