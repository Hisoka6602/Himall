		            ...
		            $(this).mouseenter(function () {
		                ...
		                if (src != '') {
			                var position = $(this).offset(),
			                	...
			                	imgstr = '<div class="lg-view-img" style="'+(pos?'bottom':'top')+':20px"><img src="' + src + '?version=' + Math.random() + '"><div class="bind-i"><i class="glyphicon glyphicon-trash"></i></div></div>';
		                    $(this).append(imgstr);
		                }
		            });
