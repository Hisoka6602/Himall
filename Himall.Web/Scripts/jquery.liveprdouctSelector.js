...
$.productSelector = {
    params: { auditStatus: 2, saleStatus: 1, selectedProductIds: [], isShopCategory: false, exceptProductIds: [], productType: -1 },
    ...
    reload: function (selectedProductIds, exceptProductIds) {
        ...
        this.loadedProducts = [];
        var url = "/SellerAdmin/Live/GetShopNotInLiveLibaryProducts";
